		...
		if(materialType == "diffuse"){
			...
			if (rayDepth < REFRACTION_DEPTH) {
				...
				if (sinA < eta) {
					...
					vec3 outputColorReflection = rayIntersect(triangleArray, triangleCount, reflectedRay, scene, rayDepth+1);
					vec3 outputColorRefraction = rayIntersect(triangleArray, triangleCount, refractedRay, scene, rayDepth+1);
